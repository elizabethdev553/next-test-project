...
export default function Dashboard() {
  ...
  return (
    <div className='w-full h-screen flex items-center justify-center text-white bg-gray-700 flex-col tracking-widest uppercase'>
      <p className='text-4xl font-extrabold mb-4'>Welcome to My Dashboard</p>
